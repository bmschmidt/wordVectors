...
google_part_1 = read.binary.vectors("~/vector_models/GoogleNewsPartial.bin",nrow=50000,cols=1:150)
google_part_2 = read.binary.vectors("~/vector_models/GoogleNewsPartial.bin",nrow=50000,cols=151:300)

aligned_pair <- align_models(google_part_1,google_part_2)


google_part_1 %>% nearest_to(google_part_2[["good"]])

goohah[[1]] %>% nearest_to(goohah[[2]][["good"]])
goohah[[1]] %>% nearest_to(goohah[[1]][["good"]])

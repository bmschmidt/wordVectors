...
plot$data$lab1 = paste(plot$data$lab1,"      ")
plot
```
...
``` {r}
with(models, usage_slopegraph("immigration", `All_1923-1945`, `All_1945-1968`))
```
...
stanford_plot(aligned, word = c("freedom","liberty"), 15, transform_type = "pca")
```
